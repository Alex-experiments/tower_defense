class Tower{
  ...
  void init_param_tower(){
    ...
    switch(type){
      case "dart monkey":
        ...
        attack_speed_list.append(1.03 * joueur.game_speed);        
      ...
      case "wizard monkey":
        ...
        deviation_list.append(0);
        attack_speed_list.append(0.91 * joueur.game_speed);
      ...
      case "sniper":
        ...
        price=350;
        size=base_size;
        range=24;                //c'est un sniper
        
        shoots_list.append("instant");
        deviation_list.append(0);
        attack_speed_list.append(0.45 * joueur.game_speed);
      ...
      case "tack shooter":
        ...
        for(int i=0; i<8; i++){
          ...
          attack_speed_list.append(0.6 * joueur.game_speed);
          projectile_damage_list.append(1);
          projectile_pierce_list.append(1);
          projectile_hit_exceptions.add(new StringList());
        }
      ...
      case "dartling gun":
        ...
        shoots_list.append("dart");
        deviation_list.append(0);
        attack_speed_list.append(5 * joueur.game_speed);
        projectile_damage_list.append(1);
        projectile_pierce_list.append(1);
        projectile_hit_exceptions.add(new StringList());
      ...
      case "boomerang thrower":
        ...
        deviation_list.append(0);
        attack_speed_list.append(0.75 * joueur.game_speed);
        projectile_damage_list.append(1);
      ...
      case "ninja monkey":
        ...
        deviation_list.append(0);
        attack_speed_list.append(1.67 * joueur.game_speed);
        projectile_damage_list.append(1);
        projectile_pierce_list.append(2);
        projectile_hit_exceptions.add(new StringList());
        break;
      ...
      case "spike factory":
        ...
        deviation_list.append(0);
        attack_speed_list.append(0.43 * joueur.game_speed);
        projectile_damage_list.append(1);
  ...
  ArrayList<Mob> get_enemis_in_range(){
    ...
    for(Mob mob : enemis){
      if(type.equals("sniper") || distance(new float[] {mob.x, mob.y}, new float[] {x, y})<=range+mob.size/2){    //je prefere reconstruire 1 a 1 : évite peut etre des prbms de copie
  ...
  void shoot_general(){
    ...
    if(type.equals("dartling gun")){    //tour qui n'as pas besoin de détecter un mob pour tirer
      ...
      for(int i=0; i<shoots_list.size(); i++){
        ...
        while(time_before_next_attack<=0){
          ...
          projectiles.add(new Projectile(this, x, y, projectile_speed * joueur.game_speed, direction+deviation, projectile_damage, projectile_pierce, projectile_can_bounce, shoot_type, hit_exceptions));
          time_before_next_attack += joueur.game_speed / attack_speed;      //affecter la valeur reste utile pour le while (sinon il faut remplacer par un _list.get(i)<=0 )
    ...
    else if(type.equals("spike factory")){    //tour qui n'as pas besoin de détecter un mob
      ...
      for(int i=0; i<shoots_list.size(); i++){
        ...
        while(time_before_next_attack <= 0){
          ...
          spikes.add(new Spikes(this, on_track_pos.get(index)[0], on_track_pos.get(index)[1], projectile_damage, projectile_pierce, shoot_type, hit_exceptions, projectile_speed * joueur.game_speed));
        ...
        while(time_before_next_attack <= 0){
          ...
          if(shoot_type.equals("laser")){
            ...
            if(type=="tack shooter"){
              Projectile temp=new Projectile(this, x, y, projectile_speed * joueur.game_speed, deviation, projectile_damage, projectile_pierce, projectile_can_bounce, shoot_type, hit_exceptions);
  ...
  void update_time_before_next_attack(){
    ...
    for(int i=0; i<time_before_next_attack_list.size(); i++){
      ...
      if(timer>0)  time_before_next_attack_list.set(i, timer - joueur.game_speed / frameRate);
    }
  }
  ...
  void shoot_boomerang(Mob target, int projectile_damage, int projectile_pierce, StringList hit_exceptions){
    ...
    boomerangs.add(new Boomerang(this, pos_finale[0], pos_finale[1], range/2, projectile_speed * joueur.game_speed, projectile_damage, projectile_pierce, hit_exceptions));
