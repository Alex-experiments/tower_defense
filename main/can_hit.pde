static final StringList sharp_list = new StringList("dart", "sharp dart", "powerful dart", "razor sharp dart", "blade", "maelstrom blade", "basic boomerang", "multi target boomerang", "glaive boomerang", "glaive ricochet", "tack", "shuriken", "sharp shuriken", "seeking shuriken", "bullet", "spike", "stack spike");
static final StringList normal_list = new StringList("huge dart ball", "red hot boomerang", "red hot multi target boomerang", "red hot glaive boomerang", "red hot glaive ricochet", "full metal bullet", "point five bullet", "deadly bullet", "bloontonium dart", "bloontonium laser cannon", "ray of doom", "hydra rocket", "purple ball", "huge purple ball", "fireball", "flame", "flash bomb", "hot spike", "spike ball", "spike mine");
static final StringList shatter_list = new StringList("dart ball", "sonic boomerang", "sonic multi target boomerang", "sonic glaive boomerang", "sonic glaive ricochet", "laser cannon");
